...
from utils.styling import inject_custom_css, render_metric_card   # <- render_custom_sidebar DIHAPUS

# (blok st.set_page_config(...) DIHAPUS — sudah dipanggil sekali di app.py)
