...
def inject_custom_css(theme_mode="Sistem"):
    ...
    st.markdown(f"""
        ...
        .list-item-card:hover {{
            border-color: {card_hover_border};
            background-color: rgba(64, 105, 175, 0.08);
        }}
...
def render_theme_selector():
    """
    Merender panel kecil di sidebar kiri khusus untuk memilih mode tema
    (Sistem / Terang / Gelap). Navigasi antar halaman TIDAK lagi di sini —
    itu sudah dipindahkan ke navbar atas lewat st.navigation(position="top")
    di app.py.
    """
